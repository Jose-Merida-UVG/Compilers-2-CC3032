// Caso de prueba: válido, complejidad MEDIA (debe compilar sin errores).
// Incluye todo lo de "baja" más: arreglo, 2 clases, 2 objetos instanciados,
// 2 funciones declaradas y llamadas.
